...
import th.code.share.common.v3.common.CommonResponseMode;
import th.code.share.common.v3.common.ER;
...
public class GlobalExceptionHandler {
    ...
    public ER handleExceptionInternal(Exception e, WebRequest request) {
        ...
        Integer code = ERMode.SERVER_ERROR.getCode();
        return new ER(code, getLocaleMessage(code, ERMode.SERVER_ERROR.getMessage()));
    }
