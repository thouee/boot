...
public class GlobalExceptionHandler {
    ...
    public ER handleExceptionInternal(Exception e, WebRequest request) {
        ...
        Integer code = ResponseMode.SERVER_ERROR.getCode();
        return new ER(code, getLocaleMessage(code, ResponseMode.SERVER_ERROR.getMessage()));
    }
    ...
    private String getLocaleMessage(Integer code, Object[] args, String defaultMessage) {
        try {
            return messageSource.getMessage("response." + code, args, defaultMessage,
